...
tab_select = [
                 ...
                 [sg.Text(' '*100)],
                 [sg.Text('Reynolds number calculator   Re=(v l) / \u03BD                                                        '),sg.Button('Set Reynolds',size=(10, 1),key='rey_cal'), sg.Text(' '*50,key='rey_rezalt'), ],
                 [sg.Text('Velocity'),sg.Input(default_text='10', size=(4, 1), key='velocity'),sg.Text('m/s'),sg.Text('Chord width'),sg.Input(default_text='.2', size=(3, 1), key='chord'),sg.Text('m'),sg.Text('temperatures'),sg.Combo((-10,0,10,20),change_submits=True,default_value=20,key='temp'), sg.Text('Kinematic Viscosity'),sg.Text('1.5111E-5',key='Viscosity')],
                 [sg.Text(' '*100)],
